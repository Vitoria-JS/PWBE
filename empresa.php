...
<!--Autenticação CMS-->
        ...
        <div id="containerGeral" class="centraliza">
            <div class="centraliza">
                <h1 class="empresa texto">SOBRE NÓS</h1>
                <div class="conteudoEmpresaVerticalEsquerdo">
                    <div class="conteudoEmpresaVerticalEsquerdoSuperior">
                        <h2 class="h2empresa centraliza">Muito prazer</h2>
                        <h1 class="h1empresa">CONHEÇA A </h1>
                        <h1 class="h1empresa">NOSSA HISTÓRIA</h1><br>
                        <p class="pempresa">Uma colher de criatividade, duas xícaras de capricho, e uma pitada de descontração. Esse é o tempero especial da nossa hamburgueria que possui em sua arquitetura o estilo madeira, que busca refletir os nossos lares onde nos sentimos aconchegantes com aquela comida boa. ~SR.Douglas Funny</p>
                        <p class="pempresa">Aqui, você se sente à vontade para bater papo, rir e curtir bons momentos com sua família e amigos.</p>
                    </div>
                    <div  class="conteudoEmpresaVerticalEsquerdoInferior">
                        <img class="imgempresa" src="imagens/empresa1.0.jpg" title="hamburguerempresa">
                    </div>
                </div>
                <div class="conteudoEmpresaVerticalDireito">
                    <div>
                        <img class="imgempresa2" src="imagens/filiais3.jpg">
                    </div>
                    <div>
                    <img class="imgempresa3" src="imagens/filiais4.jpg">
                    </div>
                </div>
            </div>
        </div>
