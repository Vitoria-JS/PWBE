...
<!--Autenticação CMS-->
        ...
        <div id="containerGeralMes" class="centraliza">
            <div class="centraliza">
            <h1 class="produtomes texto">PRODUTO DO MÊS</h1>
                <div id="sloganProdutoMes" class="centraliza">
                    <h1>Familia Uzumaki</h1>
                    <h1>4 lanches</h1>
                    <h3>Descrição:</h3>
                    <p>Combo do mês com pão brioche, bacon crocante, cebola empanada e temperada, mandioca frita, batata frita, fatias de cebola roxa, alface e tomate, fatias de queijo, molho de tomate, molho de maionese artesanal, pickles e ovo frito.</p>
                    <p>**Acompanha 4 bebidas**</p>
                    <p>Preço: R$70,00</p>
                </div>
            </div>    
        </div>
